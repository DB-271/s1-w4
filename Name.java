public class Name {
   ...
   public String initials() {
      return myFirst.substring(0, 1).toUpperCase() + myMiddle.substring(0, 1).toUpperCase()
            + myLast.substring(0, 1).toUpperCase();
   }

   public String nickName() {
      String nick = myFirst.substring(0, 1) + myLast.substring(0, 2);
